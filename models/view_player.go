...
// Validate validates this view player
func (m *ViewPlayer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ViewPlayer) validateAnomalies(formats strfmt.Registry) error {
...
func (m *ViewPlayer) validateBounties(formats strfmt.Registry) error {
...
func (m *ViewPlayer) validateEnemies(formats strfmt.Registry) error {
...
func (m *ViewPlayer) validateMapSize(formats strfmt.Registry) error {
...
func (m *ViewPlayer) validateTransports(formats strfmt.Registry) error {
...
func (m *ViewPlayer) validateWantedList(formats strfmt.Registry) error {
...
// ContextValidate validate this view player based on the context it is used
func (m *ViewPlayer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ViewPlayer) contextValidateAnomalies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) contextValidateBounties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) contextValidateEnemies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) contextValidateMapSize(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) contextValidateTransports(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) contextValidateWantedList(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ViewPlayer) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ViewPlayer) UnmarshalBinary(b []byte) error {
	var res ViewPlayer
